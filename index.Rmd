...
Here, a bright line runs approximately halfway through the piece. This indicates that the pitch content of this spot is quite different from that of the rest of the piece. 
...
Here is a cepstrogram showing different timbre-elements of [this recording by Jacques Loussier](https://open.spotify.com/track/2RQVtPukyUHJp1TFE1R66J).
...
Here are four chromagrams of the the piece. Visually, they have the same signature despite different tempi and x axes. Visually, we can see Gould's stoccato playing when compared to Gulda. Pre-track silence is visible on Kempf's recording. 
